...
function Home() {
  ...
  return (
    <div className="App max-[500px]:text-center" id="skills">
      ...
      <div className="mt-3 flex justify-content-center gap-24 flex-wrap max-[500px]:flex-col">
        <div
          ref={ref}
          style={{
            transform: isInView ? "none" : "translateX(-200px)",
        ...
        <div
          ...
          style={{
            transform: isInView ? "none" : "translateX(-200px)",
            opacity: isInView ? 1 : 0,
            transition: "all .6s cubic-bezier(0.17, 0.55, 0.55, 1) 0.6s",
          }}
          className="tech mb-5 mb-md-0"
        >
          <div className="icon-container m-auto">
        ...
        <div
          ...
          style={{
            transform: isInView ? "none" : "translateX(-200px)",
            opacity: isInView ? 1 : 0,
            transition: "all .7s cubic-bezier(0.17, 0.55, 0.55, 1) 0.7s",
          }}
          className="tech mb-5 mb-md-0"
        >
          <div className="icon-container m-auto">
        ...
        <div
          ...
          style={{
            transform: isInView ? "none" : "translateX(-200px)",
            opacity: isInView ? 1 : 0,
            transition: "all .8s cubic-bezier(0.17, 0.55, 0.55, 1) 0.8s",
          }}
          className="tech mb-5 mb-md-0"
        >
          <div className="icon-container m-auto">
        ...
        <div
          ...
          style={{
            transform: isInView ? "none" : "translateX(-200px)",
            opacity: isInView ? 1 : 0,
            transition: "all .9s cubic-bezier(0.17, 0.55, 0.55, 1) 0.9s",
          }}
          className="tech mb-5 mb-md-0"
        >
          <div className="icon-container m-auto">
        ...
        <div
          ...
          className="tech mb-5 mb-md-0 transition-all"
        >
          <div className="icon-container m-auto">
            <img
        ...
        <div
          ...
          style={{
            transform: isInView ? "none" : "translateX(-200px)",
            opacity: isInView ? 1 : 0,
            transition: "all 1.1s cubic-bezier(0.17, 0.55, 0.55, 1) 1.1s",
          }}
          className="tech mb-5 mb-md-0"
        >
          <div className="icon-container m-auto">
        ...
        <div
          ...
          style={{
            transform: isInView ? "none" : "translateX(-200px)",
            opacity: isInView ? 1 : 0,
            transition: "all 1.3s cubic-bezier(0.17, 0.55, 0.55, 1) 1.3s",
          }}
          className="tech mb-5 mb-md-0"
        >
          <div className="icon-container m-auto">
        ...
        <div
          ...
          style={{
            transform: isInView ? "none" : "translateX(-200px)",
            opacity: isInView ? 1 : 0,
            transition: "all 1.4s cubic-bezier(0.17, 0.55, 0.55, 1) 1.4s",
          }}
          className="tech mb-5 mb-md-0"
        >
          <div className="icon-container m-auto">
        ...
        <div
          ...
          style={{
            transform: isInView ? "none" : "translateX(-200px)",
            opacity: isInView ? 1 : 0,
            transition: "all 1.6s cubic-bezier(0.17, 0.55, 0.55, 1) 1.6s",
          }}
          className="tech mb-5 mb-md-0"
        >
          <div className="icon-container m-auto">
        ...
        <div
          ...
          style={{
            transform: isInView ? "none" : "translateX(-200px)",
            opacity: isInView ? 1 : 0,
            transition: "all 1.7s cubic-bezier(0.17, 0.55, 0.55, 1) 1.7s",
          }}
          className="tech mb-5 mb-md-0"
        >
          <div className="icon-container m-auto">
